 ...
 *
 * <p>
 * Hereda de la clase abstracta {@link Cliente} y no añade atributos
 * adicionales.
 * Se identifica mediante el valor de discriminador {@code Estandar} en la tabla
 * única de clientes.
 * </p>
 *
 * <p>
 * Esta clase se usa para diferenciar clientes estándar en operaciones como
 * filtrado,
