...
public class DatosIniciales {
    ...
    public static void cargar() {
        ...
        Cliente c6 = new ClienteEstandar("Zaira", "Pasaje de Pepe Teruel 53 Puerta 2 , Las Palmas, 31555", "33540256E",
        ...
        Cliente c10 = new ClienteEstandar("Albert", "Cuesta de Carlota Anaya 35 Piso 6 , Ourense, 82266", "29484897N",
        ...
        Cliente c12 = new ClientePremium("Bernabé", "Acceso de Haydée Bello 36 Apt. 49 , Barcelona, 21292", "65132486J",
        ...
        Cliente c14 = new ClientePremium("Alberto", "Urbanización de Ramiro Benavente 301 Apt. 85 , Sevilla, 25597",
                "94782628C", "fausto21@yahoo.com", 30);
        Datos.getClientes().add(c14);
        Cliente c15 = new ClienteEstandar("Teófilo", "Avenida Conrado Torrens 53 Piso 9 , Sevilla, 44341", "94341991L",
                "pioctavia@roman.org");
        Datos.getClientes().add(c15);
        Cliente c16 = new ClienteEstandar("Camilo", "Pasadizo Emiliana Gras 98 Apt. 35 , Lugo, 48773", "47856012R",
                "joaquinplana@perera.com");
        Datos.getClientes().add(c16);
        Cliente c17 = new ClientePremium("Natalio", "Pasaje de Noa Cases 506 Piso 9 , Valencia, 47793", "40131672Z",
                "utorre@yahoo.com", 30);
        ...
        Cliente c21 = new ClienteEstandar("Zoraida", "Alameda de Herberto Montenegro 92, Girona, 24326", "22976230D",
                "lupitaalcazar@gmail.com");
        Datos.getClientes().add(c21);
        Cliente c22 = new ClienteEstandar("Sofía", "Plaza Leticia Múgica 96 Apt. 11 , Valencia, 70505", "95570399V",
                "adolfo35@yahoo.com");
        ...
        Cliente c24 = new ClienteEstandar("Martin", "Via Olimpia Montenegro 6 Puerta 9 , Cuenca, 89425", "48132979N",
        ...
        Cliente c26 = new ClienteEstandar("Dionisio", "Glorieta Arturo Armas 471 Apt. 06 , Burgos, 48639", "16370376Y",
                "vcobo@fabregas-saavedra.es");
        Datos.getClientes().add(c26);
        Cliente c27 = new ClienteEstandar("Yaiza", "Avenida de Jose Luis Lledó 1 Apt. 86 , León, 49096", "03523591W",
                "cllorens@gmail.com");
        ...
        Cliente c29 = new ClientePremium("Matías", "Avenida de Ainoa Gual 92 Piso 6 , Tarragona, 93658", "30237251Z",
        ...
        Cliente c31 = new ClientePremium("Benigno", "Urbanización de Apolonia Oller 23 Piso 2 , Barcelona, 03460",
                "22442120E", "wvillegas@yahoo.com", 30);
        Datos.getClientes().add(c31);
        Cliente c32 = new ClienteEstandar("Lina", "Urbanización Alex Codina 31 Apt. 75 , Soria, 72025", "49493721L",
                "vilaltageraldo@yahoo.com");
        Datos.getClientes().add(c32);
        Cliente c33 = new ClientePremium("Ambrosio", "Via de Victorino Parejo 45 Puerta 4 , Ávila, 25405", "91249396D",
        ...
        Cliente c35 = new ClientePremium("Luciana", "Alameda Zaida Rojas 5 Apt. 07 , Albacete, 47475", "73931119Q",
        ...
        Cliente c37 = new ClientePremium("Goyo", "Calle Hilda Santamaría 45 Apt. 28 , Sevilla, 31514", "20882157K",
        ...
        Cliente c41 = new ClientePremium("Guiomar", "Cuesta Pastora Solera 774 Piso 6 , Valladolid, 71912", "33790926G",
                "imeldallanos@gmail.com", 30);
        Datos.getClientes().add(c41);
        Cliente c42 = new ClientePremium("Buenaventura", "Camino de Fito Hierro 86, Palencia, 16286", "19310549R",
                "eutimiocapdevila@carmona.org", 30);
        Datos.getClientes().add(c42);
        Cliente c43 = new ClientePremium("Azeneth", "Cañada Ciriaco Mateos 68 Apt. 10 , Zamora, 82113", "15603286H",
                "sotoruth@rodriguez.com", 30);
        Datos.getClientes().add(c43);
        Cliente c44 = new ClientePremium("Sandra", "C. Ambrosio Sevillano 87 Puerta 3 , Sevilla, 80823", "29623174J",
                "rosalva86@gmail.com", 30);
        Datos.getClientes().add(c44);
        Cliente c45 = new ClienteEstandar("Alonso", "Pasaje Francisco Jose Carpio 6 Apt. 50 , Las Palmas, 02540",
        ...
        Datos.getPedidos()
                .add(new Pedido(3, 2, LocalDateTime.of(2025, 04, 11, 12, 50),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("adolfo35@yahoo.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A143")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(4, 4, LocalDateTime.of(2025, 04, 11, 13, 12),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("joaquinplana@perera.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A134")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(5, 4, LocalDateTime.of(2025, 04, 11, 13, 8),
                        Datos.getClientes().stream()
                                .filter(x -> x.getEmail().equals("casandrapazos@pascual-rodrigo.es")).findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A126")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(6, 5, LocalDateTime.of(2025, 04, 11, 13, 02),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("qgalindo@gmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A103")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(7, 3, LocalDateTime.of(2025, 04, 11, 12, 38),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("borja47@hotmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A116")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(8, 2, LocalDateTime.of(2025, 04, 11, 12, 55),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("izquierdoagustin@pulido.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A137")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(9, 4, LocalDateTime.of(2025, 04, 11, 12, 52),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("eibanez@font.es")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A002")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(10, 3, LocalDateTime.of(2025, 04, 11, 12, 50),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("imeldallanos@gmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A124")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(11, 4, LocalDateTime.of(2025, 04, 11, 12, 33),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("ana@email.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A104")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(12, 3, LocalDateTime.of(2025, 04, 11, 12, 26),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("bsegarra@olive.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A113")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(13, 4, LocalDateTime.of(2025, 04, 11, 13, 21),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("telmo84@herrera.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A112")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(14, 1, LocalDateTime.of(2025, 04, 11, 13, 9),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("pioctavia@roman.org")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A138")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(15, 4, LocalDateTime.of(2025, 04, 11, 12, 58),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("ameliazurita@olivares-giron.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A110")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(16, 5, LocalDateTime.of(2025, 04, 11, 12, 53),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("eutimiocapdevila@carmona.org"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A115")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(17, 1, LocalDateTime.of(2025, 04, 11, 13, 57),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("kalamo@gmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A108")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(18, 2, LocalDateTime.of(2025, 04, 11, 12, 24),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("loreto62@tamarit.net"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A002")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(19, 1, LocalDateTime.of(2025, 04, 11, 14, 10),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("cuencaflor@yahoo.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A111")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(20, 2, LocalDateTime.of(2025, 04, 11, 12, 58),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("casanovassamanta@hotmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A130")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(23, 1, LocalDateTime.of(2025, 04, 11, 13, 12),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("pioctavia@roman.org")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A136")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(24, 3, LocalDateTime.of(2025, 04, 11, 12, 40),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("jcamara@andreu-riquelme.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A109")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(25, 3, LocalDateTime.of(2025, 04, 11, 13, 55),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("cllorens@gmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A123")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(26, 5, LocalDateTime.of(2025, 04, 11, 13, 40),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("romulomorcillo@hotmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A136")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(28, 2, LocalDateTime.of(2025, 04, 11, 12, 32),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("borja16@bayon-pedraza.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A106")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(29, 3, LocalDateTime.of(2025, 04, 11, 13, 13),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("pacacamino@prats-murillo.net"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A106")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(31, 4, LocalDateTime.of(2025, 04, 11, 13, 49),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("hrosa@machado.org")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A140")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(32, 3, LocalDateTime.of(2025, 04, 11, 13, 9),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("pacacamino@prats-murillo.net"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A142")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(34, 4, LocalDateTime.of(2025, 04, 11, 12, 36),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("susanita70@hotmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A139")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(35, 1, LocalDateTime.of(2025, 04, 11, 12, 13),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("nereaarjona@yahoo.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A128")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(36, 5, LocalDateTime.of(2025, 04, 11, 13, 05),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("luis@email.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A140")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(39, 1, LocalDateTime.of(2025, 04, 11, 13, 15),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("qgalindo@gmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A120")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(40, 1, LocalDateTime.of(2025, 04, 11, 13, 12),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("nereaarjona@yahoo.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A105")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(41, 4, LocalDateTime.of(2025, 04, 11, 12, 41),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("ferrandizpelayo@yahoo.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A132")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(43, 5, LocalDateTime.of(2025, 04, 11, 14, 07),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("jonatanborja@bosch-fernandez.es"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A100")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(44, 1, LocalDateTime.of(2025, 04, 11, 13, 54),
                        Datos.getClientes().stream()
                                .filter(x -> x.getEmail().equals("heribertoreina@juan-figueras.com")).findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A105")).findFirst().get()));
        Datos.getPedidos()
        ...
        Datos.getPedidos()
                .add(new Pedido(46, 4, LocalDateTime.of(2025, 04, 11, 13, 26),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("kalamo@gmail.com")).findFirst()
                                .get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A125")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(47, 5, LocalDateTime.of(2025, 04, 11, 13, 25),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("juan-pablovillena@gmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A145")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(48, 5, LocalDateTime.of(2025, 04, 11, 13, 44),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("mariscalodalis@yahoo.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A138")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(49, 5, LocalDateTime.of(2025, 04, 11, 13, 07),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("juan-pablovillena@gmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A114")).findFirst().get()));
        Datos.getPedidos()
                .add(new Pedido(50, 5, LocalDateTime.of(2025, 04, 11, 13, 55),
                        Datos.getClientes().stream().filter(x -> x.getEmail().equals("fajardozaida@gmail.com"))
                                .findFirst().get(),
                        Datos.getArticulos().stream().filter(x -> x.getCodigo().equals("A001")).findFirst().get()));
    }
}
